...
{
  // Queens can move diagonally, horizontally, or vertically in any direction
      ...
      public void action() 
      {
    	// Receive a message from Robot agent
          ...
          //System.out.println(getNextMoves(Piece_Position));
        	...
        	System.out.println("Content Sent From Queen: "+content1);
  ...
  public static List<String> getNextMoves(String position) {
	  // Get the row and column of the current position
	    ...
	    // Add the horizontal and vertical moves for the queen
	    for (int i = 0; i < 8; i++) {
	    ...
	    // Add the diagonal moves for the queen
